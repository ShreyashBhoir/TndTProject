 ...
 * 
 * 
 * private String userName; private String password; private boolean isActive;
 * private List<GrantedAuthority> authorities;
 * 
 * public UserDetailImplementation(User user) { this.userName =
 * user.getUserName(); this.password = user.getPassword(); this.isActive =
 * user.getIsActive(); this.authorities = Collections.singletonList(new
 * SimpleGrantedAuthority(user.getRoles().toUpperCase())); // this.authorities =
